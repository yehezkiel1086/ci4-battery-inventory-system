...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-slate-500 border-e border-default">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="/batteries" class="flex items-center px-2 py-1.5 text-white rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Batteries</span>
            </a>
         </li>
         <li>
            <a href="/inventory" class="flex items-center px-2 py-1.5 text-white rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
